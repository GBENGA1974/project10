...
resource "aws_autoscaling_group" "ecs_asg" {
  ...
  vpc_zone_identifier       = [aws_subnet.project10-pubsubnet1.id, aws_subnet.project10-pubsubnet2.id]

  target_group_arns     = [aws_alb_target_group.project10_alb_target_group.arn]
